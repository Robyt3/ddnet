...
build_cmake_lib boringssl https://boringssl.googlesource.com/boringssl "a1b6110c3aae7654cd88128186ea826cc27535be"

# zlib (required to build libpng, curl and freetype for webasm)
if [[ "$TARGET_PLATFORM" == "webasm" ]]; then
	log_info_header "Building zlib..."
	build_cmake_lib zlib https://github.com/madler/zlib "v1.3.1.2"
fi
