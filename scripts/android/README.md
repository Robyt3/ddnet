...
-	Install the Android NDK (version 29) in the same location
	...
	unlink android-ndk-r29-linux.zip
	```
-	Install the Android SDK build tools (version 36.1) in the same location
	...
	unlink build-tools_r36.1_linux.zip
	mv android-16 36.1
	```
-	Install the Android command-line tools and accept the licenses using the SDK manager,
	...
	unlink commandlinetools-linux-13114758_latest.zip
