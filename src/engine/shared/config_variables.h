...
#if defined(CONF_PLATFORM_ANDROID)
/* Use lower quality and faster preset for Android to avoid choppy rendering */
MACRO_CONFIG_INT(ClVideoX264Crf, cl_video_crf, 24, 0, 51, CFGFLAG_CLIENT | CFGFLAG_SAVE, "CRF (Constant Rate Factor) to encode video with x264 (0 for highest quality, 51 for lowest)")
MACRO_CONFIG_INT(ClVideoX264Preset, cl_video_preset, 3, 0, 9, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Preset to encode video with x264, default is 5 (medium), 0 is ultrafast, 9 is placebo (the slowest, not recommend)")
#else
MACRO_CONFIG_INT(ClVideoX264Crf, cl_video_crf, 18, 0, 51, CFGFLAG_CLIENT | CFGFLAG_SAVE, "CRF (Constant Rate Factor) to encode video with x264 (0 for highest quality, 51 for lowest)")
MACRO_CONFIG_INT(ClVideoX264Preset, cl_video_preset, 5, 0, 9, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Preset to encode video with x264, default is 5 (medium), 0 is ultrafast, 9 is placebo (the slowest, not recommend)")
#endif
